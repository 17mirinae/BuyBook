	...
	<div class="container px-4 px-lg-5">
		...
		<div class="row gx-4 gx-lg-5 align-items-center my-5">
			...
			<div class="col-lg-5">
				...
				<h2 class="font-weight-light">Admin Page</h2>
				<p>
					관리자님 안녕하세요!
					<br />
					관리자님의 행복한 하루를 기원합니다.
								...
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<p class="card-text">
											Buy Book 의 도서 시스템에
											<br />
											<b>도서를 추가/삭제</b>하는 기능을 이용합니다.
										</p>
										<a href="/admin/bookAdd" class="btn btn-primary">도서 추가</a>
										<a href="/admin/bookDelete" class="btn btn-primary">도서 삭제</a>
									</div>
								</div>
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<p class="card-text">
											Buy Book 의 도서 시스템에
											<br />
											<b>도서의 정보를 수정</b>하는 기능을 이용합니다.
										</p>
										<a href="/admin/bookUpdate" class="btn btn-primary">도서 수정</a>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<p class="card-text">
											Buy Book 의 도서 시스템의
											<br />
											<b>관리자 추천 도서 게시판</b>을 관리합니다.
										</p>
										<a href="/admin/goodAdd" class="btn btn-primary">추천 도서 추가</a>
										<a href="/admin/goodDelete" class="btn btn-primary">추천 도서 삭제</a>
									</div>
								</div>
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<p class="card-text">
											Buy Book 의 도서 시스템의
											<br />
											<b>자유 게시판 게시글</b>을 관리합니다.
										</p>
										<a href="/admin/boardUpdate" class="btn btn-primary">게시글 비공개 설정</a>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<p class="card-text">
											Buy Book 의 도서 시스템의
											<br />
											<b>전체 회원 목록</b>을 확인합니다.
										</p>
										<a href="/admin/userShow" class="btn btn-primary">회원 목록</a>
									</div>
								</div>
								<div class="card" style="width: 18rem;">
