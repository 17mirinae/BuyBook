...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-5">
            <a class="navbar-brand" href="/admin_index">Book Store Admin Page</a>
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center my-5">
            ...
            <div class="col-lg-5">
                <h1 class="font-weight-light">Book Store<br /> Admin Page</h1>
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Book Store 의 도서 시스템에<br /> <b>도서를 추가/삭제</b>하는 기능을 이용합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Book Store 의 도서 시스템에<br /> <b>도서의 정보를 수정</b>하는 기능을 이용합니다.</p>
