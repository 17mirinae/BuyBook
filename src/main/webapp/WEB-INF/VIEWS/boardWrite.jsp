					...
					<div class="row justify-content-center">
						<div class="card shadow-lg border-5 rounded-lg mt-5">
							<div class="card-header">
								<h3 class="text-center font-weight-light my-4">게시판 글 작성하기</h3>
							</div>
							<div class="card-body">
								<form action="/board/boardWrite" method="POST" enctype="multipart/form-data">
									<!--                                    ISBN & 제목-->
									<div class="form-floating mb-3">
										<input class="form-control" id="inputBoardTitle" type="text" placeholder="게시글 제목" name="inputBoardTitle" />
										<label for="게시글 제목">게시글 제목</label>
									</div>
									<!--                                   게시글 콘텐츠 작성-->
