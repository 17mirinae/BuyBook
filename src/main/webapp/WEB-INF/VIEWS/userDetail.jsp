		...
		<div class="row gx-4 gx-lg-5 align-items-center my-5">
			...
			<div class="col-lg-5">
				<h1 class="font-weight-light">
					MinGW's Library<br /> My Page
				</h1>
				<p>
					<%=session.getAttribute("loginMemberName")%>님 안녕하세요! <br />
					<%=session.getAttribute("loginMemberName")%>님의 행복한 하루를 기원합니다.<br /> <br /> 저희 도서관은 정상 반납한 횟수와 연체 반납 횟수를 종합해 계산하여 회원님이 대여하실 수 있는 도서의 권수를 조정해드립니다.
				</p>
			</div>
		</div>
		<!-- Call to Action-->
				...
				<div class="row gx-5 justify-content-center">
					...
					<div class="col-lg-6 col-xl-6">
						<div class="card mb-5 mb-xl-0">
							<div class="card-body p-10">
								<div class="mb-3">
									<span class="display-4 fw-bold"> 반납하기 </span>
								</div>
					...
					<div class="col-lg-6 col-xl-6">
						<div class="card mb-5 mb-xl-0">
							<div class="card-body p-10">
								<div class="mb-3">
									<span class="display-4 fw-bold"> 연장하기 </span>
								</div>
